...
urlpatterns = [
    ...
    path('scan/reward/challenge/', views.scan_reward_challenge, name='scan_reward_challenge'),
    ...
    path('strategy/<int:strategy_id>/backtest/timeframes/', views.backtest_timeframe_comparison, name='backtest_timeframe_comparison'),
